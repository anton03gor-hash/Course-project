            ...
            <div class="card-custom px-3 py-2">
                <div class="card-header bg-transparent border-bottom-0">
                    <div class="d-flex justify-content-between align-items-center">
                        <h5 class="fw-bold mb-0">
                            <i class="fas fa-edit me-2"></i>Редактировать производителя
                        </h5>
                ...
                <div class="card-body">
                    <form action="{{ route('manufacturers.update', $manufacturer) }}" method="POST">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <input type="text" class="form-control @error('name') is-invalid @enderror"
                                       id="name" name="name" value="{{ old('name', $manufacturer->name) }}" 
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('country') is-invalid @enderror"
                                       id="country" name="country" value="{{ old('country', $manufacturer->country) }}" 
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('city') is-invalid @enderror"
                                       id="city" name="city" value="{{ old('city', $manufacturer->city) }}" 
                            ...
                            <div class="col-md-8 mb-3">
                                ...
                                <input type="text" class="form-control @error('street') is-invalid @enderror"
                                       id="street" name="street" value="{{ old('street', $manufacturer->street) }}" 
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control @error('house_number') is-invalid @enderror"
                                       id="house_number" name="house_number" value="{{ old('house_number', $manufacturer->house_number) }}" 
                        ...
                        <!-- Кнопки -->
                        <div class="d-flex justify-content-between align-items-center">
                            <a href="{{ route('manufacturers.show', $manufacturer) }}" class="btn btn-outline-gray">
                                <i class="fas fa-eye me-2"></i>Просмотр
                            </a>
                            <div>
                                <a href="{{ route('manufacturers.index') }}" class="btn btn-outline-gray me-2">
                                    <i class="fas fa-times me-2"></i>Отмена
                                </a>
                                <button type="submit" class="btn btn-gray">
                                    <i class="fas fa-save me-2"></i>Обновить производителя
                                </button>
                            </div>
                        </div>
                    </form>
