            ...
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('manufacturers.index') }}">Производители</a></li>
                ...
                <div class="btn-group">
                    ...
                    <a href="{{ route('manufacturers.edit', $manufacturer) }}" class="btn btn-outline-gray">
            ...
            <div class="card-custom h-100 py-2 px-3">
                <div class="card-header bg-transparent border-bottom-0">
                    <h5 class="fw-bold mb-0">
                        <i class="fas fa-info-circle me-2"></i>Информация о производителе
                    </h5>
                </div>
                <div class="card-body">
                    <div class="row mb-4">
                        <div class="col-md-6">
                            <label class="form-label text-muted">Название производителя</label>
                            <p class="fw-bold fs-5">{{ $manufacturer->name }}</p>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label text-muted">ID производителя</label>
                            <p class="fw-bold">#{{ $manufacturer->id }}</p>
                        </div>
                    </div>
                    ...
                    <div class="row mb-4">
                        <div class="col-12">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <label class="form-label text-muted">Дом</label>
                                    <p>{{ $manufacturer->house_number }}</p>
                                </div>
                            </div>
                            <div class="mt-2">
                                <p class="fw-bold">{{ $manufacturer->full_address }}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <p>{{ $manufacturer->created_at->format('d.m.Y H:i') }}</p>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label text-muted">Последнее обновление</label>
                            <p>{{ $manufacturer->updated_at->format('d.m.Y H:i') }}</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="text-center mb-4">
                        <div class="bg-light rounded-circle d-inline-flex align-items-center justify-content-center"
                            ...
                            <i class="fas fa-industry fa-2x text-gray-500"></i>
                        </div>
                    </div>
                    <div class="list-group list-group-flush">
                        <div class="list-group-item d-flex justify-content-between align-items-center px-0">
                            <span>Товаров производителя</span>
                            <span class="badge bg-primary">{{ $products->total() }}</span>
                        </div>
                        <div class="list-group-item d-flex justify-content-between align-items-center px-0">
                            <span>Дата создания</span>
                            <span>{{ $manufacturer->created_at->format('d.m.Y') }}</span>
                        </div>
                        <div class="list-group-item d-flex justify-content-between align-items-center px-0">
                            <span>Страна</span>
                            <span class="badge bg-light text-dark">{{ $manufacturer->country }}</span>
                        </div>
                        <div class="list-group-item d-flex justify-content-between align-items-center px-0">
                            <span>Статус</span>
                            @if($products->total() > 0)
        ...
        <div class="col-12">
            <div class="card-custom py-2 px-3">
                <div class="card-header bg-transparent border-bottom-0 d-flex justify-content-between align-items-center">
                    <h5 class="fw-bold mb-0">
                        <i class="fas fa-boxes me-2"></i>Товары производителя
                    </h5>
                    <a href="{{ route('products.create') }}?manufacturer_id={{ $manufacturer->id }}" class="btn btn-sm btn-gray">
                ...
                <div class="card-body">
                    ...
                    @else
                        <div class="text-center py-4">
                            ...
                            <h5 class="text-muted">У производителя нет товаров</h5>
                            <p class="text-muted">Добавьте первый товар этого производителя</p>
                            <a href="{{ route('products.create') }}?manufacturer_id={{ $manufacturer->id }}" class="btn btn-gray">
